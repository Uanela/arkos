...
date: 2026-03-08
description: Starting in v1.6, Arkos introduces `ArkosPolicy` — a cleaner, more explicit way to define access control for your modules. The old `.auth.ts` files still work, but they're deprecated and **will be removed in v2.0**.
---
