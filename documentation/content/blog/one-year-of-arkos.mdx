...
We wrote [a dedicated post about our favourite feature in 1.3](/blog/favourite-feature-in-1.3-beta) — fine-grained permission checks that slot right into your route config.
