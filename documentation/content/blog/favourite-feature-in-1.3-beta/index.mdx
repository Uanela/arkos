...
I am talking about the [**Fine-Grained Access Control**](https://www.arkosjs.com/docs/core-concepts/authentication/advanced/fine-grained-access-control), this feature is outrageous believe me, this really does what it says `Fine Grain The Access Control Of Resources On Your Applications` on a really easy and fascinating way.
