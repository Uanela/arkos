...
authors: [uanela]
tags: [arkosjs, arkosrouter, openapi, typescript, declarative-config, file-uploads]
date: 2025-12-01
...
You check the docs about this new feature for a fully dive into it [Request Data Validation In `v1.4.0-beta`](/docs/guides/validation/setup).
...
Check the full guide at [File Upload With Arkos Router](/docs/guides/file-handling/file-uploads/setup#auto-generated-routes-with-file-uploads).
...
With this you can easily add i18n, custom description and so many more, check it now [Exporting Auth Actions For Frontend](/docs/core-concepts/authentication/setup#exporting-auth-actions-for-frontend)
...
This finally bring the `@prisma/client` TS types to the `BaseService` class for better developer experience, check more about it at [Fully Typed Base Service Class](/docs/reference/base-service).
