...
If you would like to know how to send emails is **Arkos** without the need to create an instance of `EmailService` on your own see [Sending Emails Guide](/docs/guides/email-service).
