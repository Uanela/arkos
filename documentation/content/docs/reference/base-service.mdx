...
- Support for [Service Hooks](/docs/core-concepts/components/service-hooks) to execute custom logic
...
<Tab value="v1.4" label="v1.4.0+ (Recommended)" default>
...
- Executes [before/after/error hooks](/docs/core-concepts/components/service-hooks)
...
You can then use [**Service Hooks**](/docs/core-concepts/components/service-hooks) to customize every|some calls of `createOne` method:
...
- **[Service Hooks](/docs/core-concepts/components/service-hooks)** - Execute custom logic during CRUD operations
- **[Interceptor Middlewares](/docs/core-concepts/components/interceptors)** - HTTP-level request/response processing
- **[Adding Custom Routers](/docs/core-concepts/routing/setup)** - Create custom API endpoints
- **[Request Handling Pipeline](/docs/reference/request-handling-pipeline)** - Understand how requests flow through Arkos
...
<Tab value="after" label="After v1.4.0+ (Recommended)" default>
