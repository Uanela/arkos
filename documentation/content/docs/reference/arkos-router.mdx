...
For complete upload configuration and advanced features, see the [File Upload Guide](/docs/guides/file-uploads/setup).
...
- **[File Upload Guide](/docs/guides/file-uploads/setup)** - File upload configuration
