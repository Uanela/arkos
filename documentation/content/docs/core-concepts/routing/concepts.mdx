...
See [ArkosRouter](/docs/core-concepts/components/arkos-router) for the full configuration object reference.
...
- [ArkosRouter](/docs/core-concepts/components/arkos-router) — Full configuration object reference
