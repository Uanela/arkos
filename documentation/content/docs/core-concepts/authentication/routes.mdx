...
- **[Static RBAC](/docs/core-concepts/authentication/permissions/static)** — Role-based access control via enums
- **[Dynamic RBAC](/docs/core-concepts/authentication/permissions/dynamic)** — Runtime-configurable permissions via database
- **[Permissions](/docs/core-concepts/authentication/permissions/static)** — Fine-grained access control
