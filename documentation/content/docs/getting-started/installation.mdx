...
The quickest way to create a new Arkos.js RESTful API is using [**create-arkos**](/docs/tooling/create-arkos-cli), which sets up everything automatically for you.
