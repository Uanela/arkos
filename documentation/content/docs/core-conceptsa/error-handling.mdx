...
<Tab value="v1.5" label="Meaningful Messages (v1.5.0+)" default>
...
<Tab value="v1.4" label="Generic Messages (before)" default>
...
## Best Practices: Always Prefer [AppError](/docs/reference/app-error)
