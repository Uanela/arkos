...
- [Usage](/docs/guides/error-handling/usage) — throwing errors correctly with `AppError`
- [Error Messages](/docs/guides/error-handling/error-messages/validation) — how Arkos formats validation, authentication, and Prisma errors
- [Custom Handler](/docs/guides/error-handling/custom-handler) — adding your own error handler after Arkos's
