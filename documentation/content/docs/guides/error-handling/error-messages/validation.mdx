...
Strict mode requires every route to explicitly declare its validation intent at startup — no route can silently pass unvalidated input. See [Validation — Setup](/docs/guides/validation/setup) for the full strict mode rules and behavior table.
...
See [Validation — Setup](/docs/guides/validation/setup) for the full behavior table.
