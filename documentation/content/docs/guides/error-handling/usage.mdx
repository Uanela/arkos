...
```
Read more at [Interceptors — Handling Errors](/docs/core-concepts/components/interceptors#onerror-interceptors)
...
```
Read more at [Service Hooks — Handling Errors](/docs/core-concepts/components/service-hooks#onerror-service-hooks)
