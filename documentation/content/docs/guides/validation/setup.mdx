...
Schemas and DTOs passed to `validation` automatically generate OpenAPI parameters and request body definitions — no extra configuration needed. See [OpenAPI Documentation](/docs/guides/open-api-documentation/setup) for details.

## What's Next

- [Usage](/docs/guides/validation/usage) — validate `body`, `query`, and `params` on your routes
- [Customization](/docs/guides/validation/customization/helper-functions) — `validateDto` / `validateSchema` helpers for manual validation
