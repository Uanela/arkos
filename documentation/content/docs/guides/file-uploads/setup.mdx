...
See [File Upload Routes](/docs/guides/file-uploads/routes) for the full standalone API.
...
For all upload types (`single`, `array`, `fields`), nested field notation, and `RouteHook` examples, see [Router Upload](/docs/guides/file-uploads/router-upload).
...
- [File Upload Routes](/docs/guides/file-uploads/routes) — standalone endpoints, request format, image processing params
