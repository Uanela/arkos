...
<Callout type="info">
  `/api/uploads` is the default base route and can be customized in your config. See [File Upload Setup](/docs/guides/file-handling/file-uploads/setup) for details.
</Callout>
...
See [Router Upload](/docs/guides/file-handling/file-uploads/router-upload) for the full router upload guide.
...
See the full configuration object reference at [ArkosRouter](/docs/reference/arkos-router).
...
- [Router Upload](/docs/guides/file-handling/file-uploads/router-upload) — attaching uploads to custom and built-in routes
