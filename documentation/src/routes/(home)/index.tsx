  ...
  return (
    <div className="tailwind overflow-hidden max-w-[100vw]">
      ...
      >
        <div className="container mx-auto relative max-w-6xl">
          ...
          <p className="text-gray-400 md:text-base text-sm  font-normal sm:text-center max-w-2xl mx-auto mb-8 md:mt-4 mt-3 text-center">
            With our modern architecture and seamless integrations, we created a
            RESTful framework that lets you ship features that scale as fast as
            your application grows without worrying about standard patterns.
          </p>
          <a
      ...
      <section className="mx-auto grid lg:grid-cols-3 md:grid-cols-2 items-center justify-center  bg-gray-90 flex-col p-4 max-w-7xl relative md:gap-6 gap-4 ">
        ...
        >
          Arkos.js is a game-changer! It drastically simplifies API development,
          letting you build backend routes quickly and efficiently. Less time on
          boilerplate, more time on business logic. An incredible tool for
        ...
        >
          ...
          products. Built-in auth is powerful and ready. Automatic CRUD and docs
          save time, while interceptors allow flexible business logic. ArkosJS
          is worth adopting.
        </TestimonialCard>
        <TestimonialCard
          name="Joél Fombe"
        ...
        >
          ...
          integrates validations and auth, organizing everything into services.
          The result is a faster, simpler workflow with far less effort—a tool
          that truly accelerates development.
        </TestimonialCard>
        <TestimonialCard
        ...
        >
          ...
          simple, and incredibly productive.
        </TestimonialCard>
        <TestimonialCard
          name="Uanela Como"
          role="Founder"
        ...
        >
          ...
          what truly matters focusing on the core business logic.
        </TestimonialCard>
      </section>
