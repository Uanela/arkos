 ...
 */
export type IsArrayRelation<T> = Exclude<T, undefined> extends never
  ? false
  : Exclude<T, undefined> extends { connect?: infer C; }
  ? (Extract<Exclude<C, undefined>, any[]> extends never ? false : true)
