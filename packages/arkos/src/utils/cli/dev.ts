  ...
  try {
    ...
    if (fileExt === "ts" && !fs.existsSync(baseServiceTypesPath)) {
      ...
      if (answer) {
        ...
        throw Error(
          'Missing BaseService types please run "npx arkos prisma generate" to generate and sync the types from @prisma/client, see more at https://www.arkosjs.com/docs/tooling/cli/overviewarkos-cli#typescript-types-generation.'
        );
    }
