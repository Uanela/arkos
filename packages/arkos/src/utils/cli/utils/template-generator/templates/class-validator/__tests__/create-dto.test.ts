import { generateCreateDtoTemplate } from "../create-dto-template";
...
describe("generateCreateDtoTemplate", () => {
  ...
  describe("Error Handling", () => {
    it("should throw error when modelName is not provided", () => {
      expect(() => generateCreateDtoTemplate({} as TemplateOptions)).toThrow(
        "Module name is required for create-dto template"
      );
    });
